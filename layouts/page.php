...
<head>
	...
	<style>
		...
		.example-secondarynav, .example-contentbox {
			height: 700px;
			margin-bottom: 20px;
		}
...
<body class="style-guide">
	...
	<div class="container container-body">
		...
		<div class="row">
			<div class="span3 box example-secondarynav"><h4>Sidebar<br>Navigation (<span class="spanwidth"></span>)</h4></div>
			<div class="box span8 example-contentbox"><h4>Main Content (<span class="spanwidth"></span>)</h4></div>
		</div>
	</div>
